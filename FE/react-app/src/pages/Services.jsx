...
const Services = () => {  const services = [
    {
      ...
      icon: "🔬",
      description: "Xét nghiệm toàn diện các bệnh lây truyền qua đường tình dục với công nghệ PCR Real-time và ELISA thế hệ mới",
      features: [
    ...
    },
    {
      ...
      icon: "📊",
      description: "Ứng dụng thông minh sử dụng trí tuệ nhân tạo để theo dõi chu kỳ kinh nguyệt và dự đoán thời gian rụng trứng",
      features: [
    ...
    },
    {
      ...
      icon: "👩‍⚕️",
      description: "Tư vấn từ xa 1-1 với đội ngũ bác sĩ chuyên khoa có chứng chỉ hành nghề, bảo mật end-to-end",
      features: [
    ...
    },
    {
      ...
      icon: "💬",
      description: "Nền tảng hỏi đáp uy tín với sự tham gia của các chuyên gia từ Hội Y học Việt Nam",
      features: [
    ...
    },
    {
      ...
      icon: "📚",
      description: "Nội dung giáo dục chuyên sâu được biên soạn bởi các chuyên gia và kiểm duyệt bởi Hội Y học Việt Nam",
      features: [
    ...
    },
    {
      ...
      icon: "⭐",
      description: "Nền tảng đánh giá công khai, minh bạch với xác thực danh tính từ bệnh nhân thực",
      features: [
  ...
  return (
    <div className="services-container">      {/* Navigation Header */}
      <nav className="navbar">
        <div className="nav-brand">
          <h2>🏥 VietHealth Medical Center</h2>
          <span className="certification">Giấy phép hoạt động số: 123/GP-SKHCN</span>
        </div>
        <div className="nav-menu">
          <Link to="/home" className="nav-link">Trang Chủ</Link>
          <Link to="/services" className="nav-link active">Dịch Vụ</Link>
      ...
      <section className="services-hero">
        <div className="container">
          <div className="hero-content">
            ...
            <p>Cung cấp dịch vụ chăm sóc sức khỏe sinh sản toàn diện với đội ngũ chuyên gia có 15+ năm kinh nghiệm</p>
            ...
            {services.map(service => (
              <div key={service.id} className="service-detail-card">
                ...
                <div className="service-actions">
                  <Link to="/booking" className="btn-primary">Đặt Lịch Ngay</Link>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <div className="cta-buttons">
              <Link to="/booking" className="btn-primary">Đặt Lịch Tư Vấn</Link>
              <a href="tel:1900-xxxx" className="btn-secondary">Gọi Hotline: 1900-xxxx</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>Chúng tôi cam kết bảo mật thông tin cá nhân 100% theo tiêu chuẩn quốc tế HIPAA.</p>
            </div>
            <div className="faq-item">
              <h4>Làm thế nào để đặt lịch hẹn?</h4>
              <p>Bạn có thể đặt lịch trực tuyến qua website hoặc gọi hotline 1900-xxxx.</p>
            </div>
            <div className="faq-item">
              <h4>Chi phí xét nghiệm như thế nào?</h4>
              <p>Chi phí phụ thuộc vào loại xét nghiệm. Vui lòng liên hệ để biết báo giá chi tiết.</p>
            </div>
            <div className="faq-item">
              <h4>Kết quả xét nghiệm bao lâu có?</h4>
              <p>Hầu hết kết quả sẽ có trong 24-48 giờ, một số xét nghiệm đặc biệt có thể mất 3-5 ngày.</p>
            </div>
          </div>
        </div>
      </section>
