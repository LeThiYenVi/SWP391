    ...
    <div className="home-container">
      ...
      <div className="hero-section">
        <div className="hero-content">
          <h1>
            VietHealth Medical Center - Tiên Phong Trong Chăm Sóc Sức Khỏe Sinh
            Sản
          </h1>
          <p>
        ...
        <div className="container">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                <strong>VietHealth Medical Center</strong> là trung tâm y tế
                chuyên khoa hàng đầu Việt Nam trong lĩnh vực chăm sóc sức khỏe
                sinh sản và giới tính. Được thành lập năm 2008 với tầm nhìn trở
                thành trung tâm y tế đạt chuẩn quốc tế, chúng tôi đã không ngừng
                đầu tư vào công nghệ y tế tiên tiến và đào tạo đội ngũ chuyên
                gia đẳng cấp thế giới.
              </p>
              <p>
                Với hơn <strong>150,000</strong> bệnh nhân đã được phục vụ,
                VietHealth tự hào là một trong những trung tâm y tế đầu tiên tại
                Việt Nam đạt chứng nhận <strong>ISO 15189:2012</strong> cho
                phòng xét nghiệm và đang trong quá trình chứng nhận{" "}
                <strong>JCI Accreditation</strong> - tiêu chuẩn y tế cao nhất
                thế giới.
              </p>
              <div className="key-achievements">
                ...
                <ul>
                  <li>
                    ✅ Trung tâm y tế đầu tiên tại Việt Nam đạt độ chính xác xét
                    nghiệm 99.95%
                  </li>
                  <li>
                    ✅ Đội ngũ 80+ chuyên gia có chứng chỉ quốc tế từ Johns
                    Hopkins, Harvard Medical
                  </li>
                  <li>
                    ✅ Hệ thống AI tracking chu kỳ được phát triển độc quyền với
                    95% độ chính xác
                  </li>
                  <li>
                    ✅ Đối tác chiến lược với các bệnh viện top đầu: Từ Dũ, Bạch
                    Mai, Chợ Rẫy
                  </li>
                  <li>
                    ✅ Được WHO công nhận là mô hình chăm sóc sức khỏe sinh sản
                    tiêu biểu khu vực
                  </li>
                </ul>
              </div>
          ...
          <div className="services-grid">
            <div className="service-card">
              ...
              <p>
                ...
                công nghệ PCR Real-time và ELISA thế hệ 4
              </p>
            ...
            <div className="service-card">
              ...
              <p>
                Hệ thống AI tiên tiến phân tích chu kỳ sinh sản với thuật toán
                machine learning được đào tạo từ 1M+ dữ liệu
              </p>
              <div className="service-features">
              ...
              <Link to="/cycle-tracking" className="service-link">
                Trải nghiệm AI
              </Link>
            </div>
            ...
            <div className="service-card">
              ...
              <p>
                Nền tảng tư vấn từ xa đạt chuẩn quốc tế với bảo mật AES-256 và
                hỗ trợ đa ngôn ngữ
              </p>
              <div className="service-features">
            ...
            <div className="service-card">
              ...
              <p>
                Cộng đồng y khoa với sự tham gia của 200+ chuyên gia được chứng
                nhận và hệ thống AI fact-checking
              </p>
              <div className="service-features">
            ...
            <div className="service-card">
              ...
              <p>
                Nội dung giáo dục y khoa được thẩm định bởi Hội Y học Việt Nam
                và WHO, cập nhật theo guidelines mới nhất
              </p>
              <div className="service-features">
            ...
            <div className="service-card">
              ...
              <p>
                Hệ thống đánh giá công khai được kiểm duyệt bởi bên thứ 3 độc
                lập, đảm bảo tính xác thực 100%
              </p>
              <div className="service-features">
              ...
              <Link to="/reviews" className="service-link">
                Xem đánh giá thực
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="credentials-grid">
            <div className="credential-item">
              ...
              <p>
                Đang trong quá trình chứng nhận tiêu chuẩn y tế quốc tế cao nhất
              </p>
            </div>
            <div className="credential-item">
              <div className="credential-icon">📜</div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-item">
              <div className="testimonial-content">
                <p>
                  "VietHealth Medical Center thực sự là trung tâm y tế đẳng cấp
                  quốc tế. Quy trình xét nghiệm chuyên nghiệp, kết quả chính xác
                  và thái độ phục vụ tận tâm. Đặc biệt ấn tượng với hệ thống bảo
                  mật thông tin đạt chuẩn HIPAA."
                </p>
              </div>
            ...
            <div className="testimonial-item">
              <div className="testimonial-content">
                <p>
                  "Là một doanh nhân bận rộn, tôi đánh giá cao dịch vụ
                  telemedicine của VietHealth. Chất lượng tư vấn không khác gì
                  khám trực tiếp, công nghệ hiện đại và đội ngũ bác sĩ chuyên
                  môn cao."
                </p>
              </div>
              <div className="testimonial-author">
                ...
                <div className="author-info">
                  ...
                  <p>Giám đốc điều hành - TechCorp Vietnam</p>
                  <div className="rating">⭐⭐⭐⭐⭐</div>
                  <span className="verified">✓ Đã xác thực</span>
                </div>
              </div>
            ...
            <div className="testimonial-item">
              <div className="testimonial-content">
                <p>
                  "Với 12 năm kinh nghiệm trong ngành y tế, tôi đánh giá
                  VietHealth là một trong những trung tâm chăm sóc sức khỏe sinh
                  sản tốt nhất Việt Nam. Quy trình chuyên nghiệp, trang thiết bị
            ...
            <div className="testimonial-item">
              <div className="testimonial-content">
                <p>
                  "Hệ thống AI tracking chu kỳ của VietHealth rất chính xác,
                  giúp tôi hiểu rõ hơn về cơ thể mình. Đội ngũ hỗ trợ 24/7 luôn
                  sẵn sàng giải đáp mọi thắc mắc. Truly impressed!"
                </p>
              </div>
              <div className="testimonial-author">
                <div className="author-avatar">👩</div>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer-bottom">
            <p>
              &copy; 2024 VietHealth Medical Center. Bản quyền thuộc về
              VietHealth Medical Center.
            </p>
          </div>
        </div>
      </footer>
